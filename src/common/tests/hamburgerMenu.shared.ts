...
type HamburgerMenuTestFixtures = {
    page: Page;
...
export async function runHamburgerMenuTests(
    test: TestType<HamburgerMenuTestFixtures, any>,
    url: string,
    ...
    test('T1. Verify hamburger menu opens correctly', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
        await ScreenshotHelper(page, screenshotDir, 'T1-hamburgerMenu', testInfo);
    });

    // test('T4. Verify switching from dark theme to light theme and vice-versa', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuFixtures, testInfo: TestInfo) => {
    //     await hamburgerMenuPage.openMenu();
    //     await page.waitForTimeout(2000);
    ...
    test('T10. Verify Search field is accessible', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
    ...
    test('T11. Verify Promotions CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
    ...
    test('T12. Verify Providers CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
    ...
    test('T15. Verify Quick Links dropdown expand/collapse', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
    ...
    test('T16. Verify Privacy Policy CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
        await hamburgerMenuPage.clickQuickLinks();
    ...
    test('T17. Verify Contact Us CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
        await hamburgerMenuPage.clickQuickLinks();
    ...
    test('T18. Verify Terms & Conditions CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
        await hamburgerMenuPage.clickQuickLinks();
    ...
    test('T19. Verify FAQ’s CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
        await hamburgerMenuPage.clickQuickLinks();
    ...
    test('T21. Verify Responsible Gambling CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
        await hamburgerMenuPage.openMenu();
        await page.waitForTimeout(2000);
        await hamburgerMenuPage.clickQuickLinks();
    ...
    test.describe('Logged In Tests', () => {
        ...
        test('T29. Verify the Profile icon on header', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
        ...
        test('T35. Verify My Account dropdown expansion', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
        ...
        test('T36. Verify Deposit CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickMyAccount();
        ...
        test('T36_1. Verify Withdrawal CTA (My Account)', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickMyAccount();
        ...
        test('T36_2. Verify Transaction Summary CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickMyAccount();
        ...
        test('T41. Verify Document Verification CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickMyAccount();
        ...
        test('T42. Verify Log Out CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickMyAccount();
        ...
        test('T43. Verify Quick Links dropdown expand/collapse', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickQuickLinks();
            await hamburgerMenuPage.highlightElement('quickLinksDropdown');
        ...
        test('T44. Verify Privacy Policy CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickQuickLinks();
            await hamburgerMenuPage.highlightElement('privacyPolicyCTA');
        ...
        test('T45. Verify Contact Us CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickQuickLinks();
            await hamburgerMenuPage.highlightElement('contactUsCTA');
        ...
        test('T46. Verify Terms & Conditions CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickQuickLinks();
            await hamburgerMenuPage.highlightElement('termsConditionsCTA');
        ...
        test('T47. Verify FAQ’s CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickQuickLinks();
            await hamburgerMenuPage.highlightElement('faqsCTA');
        ...
        test('T48. Verify Responsible Gambling CTA', async ({ page, hamburgerMenuPage, screenshotDir }: HamburgerMenuTestFixtures, testInfo: TestInfo) => {
            await hamburgerMenuPage.openMenu();
            await page.waitForTimeout(1000);
            await hamburgerMenuPage.clickQuickLinks();
            await hamburgerMenuPage.highlightElement('responsibleGamblingCTA');
