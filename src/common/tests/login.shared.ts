...
export async function runLoginTests(
    test: TestType<LoginTestFixtures, any>,
    url: string,
    ...
    test('T1-Verify login Button is visible on Homepage.', async ({ page, loginPage, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.highlightLoginButton();
        await ScreenshotHelper(page, screenshotDir, 'T1-loginPage', testInfo);
    });

    test('T2-Verify that user should able to click on "Login" button', async ({ page, loginPage, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickLogin();
        await ScreenshotHelper(page, screenshotDir, 'T2-loginPage', testInfo);
    });

    test('T3 - Verify that user should able to see the "Login" button in Hamburger menu', async ({ page, loginPage, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
    ...
    test('T4 - Verify that user should able to click on "Login" button in Hamburger menu', async ({ page, loginPage, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickHamburgerMenu();
        await page.waitForTimeout(2000);
    ...
    test('T5 - Verify that user should able to see the "Login" button on signup popup window', async ({ page, loginPage, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickRegister();
        await loginPage.highlightLoginLinkInSignup();
        await ScreenshotHelper(page, screenshotDir, 'T5-loginSignupPopup', testInfo);
    });

    test('T6 - Verify that user should able to click on "Login" button on signup popup window', async ({ page, loginPage, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickRegister();
    ...
    test('T10 - Verify user is able to login from hamburger menu', async ({ page, loginPage, testData, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickHamburgerMenu();
        await page.waitForTimeout(2000);
        await loginPage.clickHamburgerLogin();
        await loginPage.performLogin(testData.loginValid.mobile, testData.loginValid.password);
    ...
    test('T11 - Verify user is able to login from signup popup', async ({ page, loginPage, testData, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickRegister();
        await loginPage.clickLoginLinkInSignup();
        await loginPage.performLogin(testData.loginValid.mobile, testData.loginValid.password);
        await page.waitForTimeout(2000);
    ...
    test('T16 - Verify user is not able to login if mobile number has more than 9 digits', async ({ page, loginPage, testData, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickLogin();
    ...
    test('T17 - Verify user is not able to login if mobile number contains alphanumeric characters', async ({ page, loginPage, testData, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickLogin();
    ...
    test('T18 - Verify user is not able to enter special characters in mobile number field', async ({ page, loginPage, testData, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickLogin();
    ...
    test('T19 - Verify that user is not able to login if password field is empty', async ({ page, loginPage, testData, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickLogin();
    ...
    test('T20 - Verify that user is not able to login if password field has less than 5 characters', async ({ page, loginPage, testData, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickLogin();
    ...
    test('T21 - Verify that user is not able to login if password field has more than 20 characters', async ({ page, loginPage, testData, screenshotDir }: LoginTestFixtures, testInfo: TestInfo) => {
        await loginPage.clickLogin();
