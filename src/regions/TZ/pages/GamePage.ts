...
/**
 * TZ GamePage — in-game structure (top bar, hamburger, share, account options) matches ZA; only
 * navigation differs: TZ's home has no featured carousel, so we reach a game via the Slot Games
